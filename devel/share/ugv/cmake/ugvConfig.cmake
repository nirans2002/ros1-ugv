...
if("TRUE" STREQUAL "TRUE")
  set(ugv_SOURCE_PREFIX /home/niran/ugv_ws/src/ugv)
  set(ugv_DEVEL_PREFIX /home/niran/ugv_ws/devel)
  set(ugv_INSTALL_PREFIX "")
  set(ugv_PREFIX ${ugv_DEVEL_PREFIX})
else()
  set(ugv_SOURCE_PREFIX "")
  set(ugv_DEVEL_PREFIX "")
  set(ugv_INSTALL_PREFIX /home/niran/ugv_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'niran <niran@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ugv' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/niran/ugv_ws/src/ugv/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ugv_NUM_DUMMY_TARGETS)
      set(ugv_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ugv::wrapped-linker-option${ugv_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ugv_NUM_DUMMY_TARGETS "${ugv_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ugv::wrapped-linker-option${ugv_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ugv_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/niran/ugv_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ugv_EXPORTED_TARGETS ${${ugv_dep}_EXPORTED_TARGETS})
endforeach()
